...
# Deployment script for Mini-task application
set -e

echo "🚀 Starting deployment of Mini-task application..."
...
sudo mkdir -p /var/www/mini-task
sudo chown $USER /var/www/mini-task
cd /var/www/mini-task

# Clone the repository (if not already present)
if [ ! -d ".git" ]; then
    echo "📥 Cloning repository..."
    git clone https://github.com/daksh204singh/mini-task-botbuilder.git .
fi
