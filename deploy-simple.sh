...
# Simple deployment script for Mini-task application
set -e

echo "🚀 Starting simple deployment of Mini-task application..."
...
cd mini-task
tar -xzf ~/mini-task-app.tar.gz --strip-components=1
